...
```shell script
export EXPR_ID=./temp/expr
export DATA_DIR=./temp/data
export CHECKPOINT_DIR=./temp/checkpoint
python train.py --data $DATA_DIR/cifar10 --root $CHECKPOINT_DIR --save $EXPR_ID --dataset cifar10 \
        ...
        --num_preprocess_blocks 1 --num_postprocess_blocks 1 --num_groups_per_scale 30 --batch_size 4 \
